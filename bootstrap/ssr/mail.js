    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$4, mergeProps({ class: "p-12 text-center" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", unref(logotype))} class="w-12 max-h-12 mb-3"${ssrRenderAttr("alt", unref(name))}${_scopeId}><a${ssrRenderAttr("href", unref(name))} class="block text-lg font-bold no-underline text-slate-800"${_scopeId}>${ssrInterpolate(unref(name))}</a>`);
          } else {
            return [
              createVNode("img", {
                src: unref(logotype),
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p${_scopeId}>Hello, ${ssrInterpolate(props.name)}!</p><p${_scopeId}>This is a mail made with Laravel, Inertia and Vue</p>`);
            ...
            return [
              ...
              createVNode("p", null, "This is a mail made with Laravel, Inertia and Vue"),
              createVNode(_sfc_main$4, { align: "center" }, {
                default: withCtx(() => [
                  createVNode(_sfc_main$4, { align: "center" }, {
                    default: withCtx(() => [
